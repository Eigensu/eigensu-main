...
.dsp-hero-glow .bottom{position:absolute;width:720px;height:720px;right:-300px;bottom:-380px;border-radius:50%;background:var(--ember);opacity:.15;}
.dsp-hero-glow .side-l{position:absolute;width:520px;height:520px;left:-340px;top:15%;border:1px solid rgba(255,197,61,.2);border-radius:50%;}
.dsp-hero-glow .side-r{position:absolute;width:240px;height:240px;right:10%;top:-130px;border:1px solid rgba(251,243,228,.08);border-radius:50%;}
...
.dsp-hero h1{margin:0 0 26px;max-width:700px;font-family:var(--font-head);font-size:clamp(3.8rem,6vw,6.6rem);font-weight:800;line-height:.9;letter-spacing:-.055em;color:var(--cream);}
.dsp-hero h1 span{color:var(--ember);}
.dsp-hero p{max-width:545px;margin:0 0 30px;color:rgba(251,243,228,.72);font-size:1rem;line-height:1.65;}
.dsp-hero .btn-row{display:flex;flex-wrap:wrap;gap:16px;}
.dsp-hero .btn{display:inline-flex;align-items:center;min-height:43px;padding:11px 18px;border-radius:11px;font-family:var(--font-body);font-size:.82rem;font-weight:700;text-decoration:none;cursor:pointer;border:none;}
...
.dsp-phone-wrap{display:flex;align-items:center;justify-content:center;min-width:0;}
...
.dsp-bubble{max-width:82%;padding:8px 11px;border-radius:10px;color:#161616;font-size:.71rem;line-height:1.35;}
        ...
        <div className="dsp-phone-wrap">
          <div className="dsp-phone">
            ...
            <div className="dsp-phone-body">
              {MESSAGES.map((m, i) => (
                <div key={i} className={`dsp-bubble ${m.dir}`}>
                  {m.text}
                  <div className="time">
                    {m.time}
