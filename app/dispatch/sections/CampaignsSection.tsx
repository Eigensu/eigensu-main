...
.dsp-f6d-item{border-bottom:1px solid rgba(251,243,228,.18);}
...
.dsp-f6d-body{max-height:0;overflow:hidden;transition:max-height .3s ease;}
.dsp-f6d-item.open .dsp-f6d-body{max-height:140px;}
